...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("MainActivity","Create invoked");
        Toast.makeText(getApplicationContext(),"Welcome to TikGet",Toast.LENGTH_SHORT).show();
        ...
        singleLady = (SwitchCompat)findViewById(R.id.single_switch);
    ...
    {
        super.onStart();
        Log.d("Activity lifecycle","Start invoked");
    ...
    {
        super.onResume();
        Log.d("Activity lifecycle","Resume invoked");
    ...
    {
        super.onPause();
        Log.d("Activity lifecycle","Paused invoked");
    ...
    {
        super.onStop();
        Log.d("Activity lifecycle","Stop invoked");
